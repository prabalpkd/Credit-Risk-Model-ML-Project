...
def prepare(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,
    ...
    df = df[features] # Ensure the DataFrame contains only the features expected by the model
    return df
...
def predict(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,
            delinquency_ratio, credit_utilization_ratio, num_open_accounts,
            residence_type, loan_purpose, loan_type):
    input_df = prepare(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,
            delinquency_ratio, credit_utilization_ratio, num_open_accounts,
            residence_type, loan_purpose, loan_type)
